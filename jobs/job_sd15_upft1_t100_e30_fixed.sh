...
#SBATCH --job-name=sd15_upft1_t100_fixed
#SBATCH --gres=gpu:1
#SBATCH --time=24:00:00
#SBATCH --output=/home/woody/rlvl/rlvl173v/revelio/logs/sd15_upft1_t100_fixed_%j.out
#SBATCH --error=/home/woody/rlvl/rlvl173v/revelio/logs/sd15_upft1_t100_fixed_%j.err
...
python train.py \
  ...
  --output_dir "./outputs/sd15_upft1_t100_e30_fixed" \
